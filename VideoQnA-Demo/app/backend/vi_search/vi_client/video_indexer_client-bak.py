...
class VideoIndexerClient:
    ...
    def get_account_async(self) -> None:
        ...
        url = f'{self.consts.AzureResourceManager}/subscriptions/{self.consts.SubscriptionId}/resourcegroups/{self.consts.ResourceGroup}/providers/Microsoft.Media/videoAnalyzers/{self.consts.AccountName}?api-version={self.consts.ApiVersion}'
